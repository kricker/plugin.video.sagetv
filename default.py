...
def VIEWLISTOFEPISODESFORSHOW(url,name):
    ...
    for mfSubset in mfs:
        ...
        if(len(segs) == 1):
            ...
            #If a recording has multiple segments, use a playlist file generated by sagex api to group the segments together such that during playback it's transparent to the user
